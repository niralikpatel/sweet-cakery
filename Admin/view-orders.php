					...
					<table>
						...
						{				?>		
						  <tr>
							...
							<td><?php echo htmlentities($result->payment_mode);?></td>
							<td><?php echo htmlentities($result->order_status);?></td>
							<td><?php echo htmlentities($result->admin_remark);?></td>
                            <td>
                                <a href="update-order.php?order_id=<?php echo htmlentities($result->order_id);?>">View</a> <span>/</span>
